    ...
    return (
        <div className="min-h-screen bg-[var(--c-bg)] pt-24 pb-20 px-4">
            <div className="container mx-auto max-w-4xl">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[var(--c-primary)]/10 text-[var(--c-primary)] text-[10px] font-bold uppercase tracking-[0.2em] mb-4">
                        <HelpCircle className="w-3.5 h-3.5" />
                        Common Queries
                    </div>
                    <h1 className="font-serif text-4xl md:text-5xl font-bold text-[var(--c-text)] mb-4">Frequently Asked Questions</h1>
                    <p className="text-[var(--c-text-muted)] text-lg max-w-xl mx-auto">Everything you need to know about our artisanal products and luxury service.</p>
                </motion.div>
                ...
                <div className="space-y-12">
                    {faqs.map((group, idx) => (
                        ...
                        >
                            <h2 className="font-serif text-2xl font-bold text-[var(--c-text)] mb-6 flex items-center gap-3">
                                <div className="w-8 h-1 bg-[var(--c-accent)] rounded-full" />
                                {group.category}
                            </h2>
                            <div className="grid gap-4">
                                {group.questions.map((item, i) => (
                                    <div key={i} className="bg-white rounded-2xl p-6 border border-[var(--c-border)] shadow-sm hover:shadow-md transition-all">
                                        <h3 className="font-bold text-[var(--c-text)] mb-3 flex items-start gap-3">
                                            <span className="text-[var(--c-primary)]">Q.</span>
                                            {item.q}
                                        </h3>
                                        <p className="text-[var(--c-text-muted)] text-sm leading-relaxed pl-7">
                                            {item.a}
                                        </p>
                                    </div>
                                ))}
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="mt-20 bg-[var(--c-text)] rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden"
                >
                    <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--c-primary)]/20 blur-[100px] rounded-full" />
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <button className="bg-[var(--c-primary)] hover:bg-[var(--c-primary-dark)] text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 transition-all">
