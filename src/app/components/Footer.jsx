...
export default function Footer() {
    ...
    return (
        <div className="bg-gradient-to-b from-[#1C2018] to-[#12140F] text-white overflow-hidden relative">
            {/* Subtle glow effect */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[300px] bg-[var(--c-primary)]/5 blur-[120px] rounded-full pointer-events-none" />
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-5 group transition-transform hover:translate-x-1">
                                <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/5 group-hover:bg-[var(--c-primary)]/20 group-hover:border-[var(--c-primary)]/20 transition-all">
                                    <item.icon className="w-5 h-5 text-white/40 group-hover:text-[var(--c-primary)] transition-colors" strokeWidth={1.5} />
                                </div>
            ...
            <section className="py-24 relative z-10 px-6">
                <div className="container mx-auto max-w-7xl">
                    <div className="bg-white/[0.03] backdrop-blur-xl rounded-[40px] border border-white/10 p-10 lg:p-16 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--c-accent)]/10 blur-[80px] rounded-full -translate-y-1/2 translate-x-1/2 group-hover:bg-[var(--c-accent)]/20 transition-colors duration-700" />
                        
                        <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                            <div>
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--c-primary)]/20 border border-[var(--c-primary)]/20 text-[var(--c-primary)] text-[10px] font-bold uppercase tracking-widest mb-4">
                ...
                <div className="container mx-auto px-6 xl:px-8 max-w-7xl">
                        ...
                        <div className="lg:col-span-4">
                            <Link href="/" className="flex items-center gap-4 mb-8 group">
                                {SITE_LOGO ? (
                                    ...
                                    <div className="w-12 h-12 bg-[var(--c-primary)] rounded-2xl flex items-center justify-center text-white shrink-0 shadow-lg shadow-[var(--c-primary)]/20 group-hover:rotate-6 transition-transform">
                            ...
                            <div className="space-y-6">
                                {contacts.phone && (
                                    <a href={`tel:${contacts.phone.value}`} className="flex items-center gap-4 text-[14px] text-white/60 hover:text-[var(--c-primary)] transition-colors group">
                                        <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-[var(--c-primary)]/10">
                                ...
                                {contacts.email && (
                                    <a href={`mailto:${contacts.email.value}`} className="flex items-center gap-4 text-[14px] text-white/60 hover:text-[var(--c-primary)] transition-colors group">
                                        <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-[var(--c-primary)]/10">
                    ...
                    <div className="mt-24 pt-12 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-10">
                        ...
                        <div className="flex flex-col items-center gap-6 order-1 lg:order-2">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-3">
                                <span className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold text-white/40 tracking-widest uppercase hover:text-white transition-all group relative overflow-hidden cursor-default">
                                    ...
                                    <div className="absolute inset-0 bg-[var(--c-primary)]/20 scale-0 group-hover:scale-100 rounded-xl transition-transform duration-500" />
                                </span>
                                <span className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold text-white/40 tracking-widest uppercase hover:text-white transition-all group relative overflow-hidden cursor-default">
                        ...
                        <div className="flex justify-center md:justify-end order-3">
                            ...
                            >
                                <span className="text-white/30 text-[10px] uppercase font-bold tracking-[0.2em] group-hover:text-[var(--c-primary)] transition-colors">Design & Developed by</span>
                                <span className="font-serif text-[18px] text-white/60 group-hover:text-white transition-all">Bihar Innovation</span>
                                <div className="h-px w-0 group-hover:w-full bg-[var(--c-primary)] transition-all duration-500" />
                            </Link>
                        </div>
                    </div>
                </div>
