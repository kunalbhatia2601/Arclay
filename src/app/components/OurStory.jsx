                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="relative animate-slide-in-left">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="col-span-2 relative aspect-[16/10] rounded-3xl overflow-hidden border border-white/5 group">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="text-center p-8">
                                        ...
                                        <p className="text-white/40 text-sm">Since 1998</p>
                                    </div>
                                </div>
                            ...
                            {/* Smaller Boxes */}
                            <div className="relative aspect-square rounded-3xl overflow-hidden border border-white/5 bg-[#121212] flex items-center justify-center group hover:bg-[#1E1E1E] transition-colors">
                                <div className="text-center">
                                    <span className="text-4xl mb-2 block animate-bounce-slow">🌿</span>
                                    <span className="text-xs font-bold text-white/50 uppercase tracking-widest">Natural</span>
                                </div>
                            </div>
                    ...
                    <div className="space-y-8 animate-slide-in-right">
                        <div>
                            ...
                            <h2 className="font-heading text-4xl lg:text-5xl font-black text-white leading-[0.9] tracking-tight">
                                {storyContent.title}
                            </h2>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-6 pt-6 border-t border-white/5">
                            {storyContent.stats.map((stat, index) => (
                                <div key={index}>
                                    <p className="font-heading text-3xl lg:text-4xl font-black text-white mb-1">
                                        {stat.value}
                                    </p>
