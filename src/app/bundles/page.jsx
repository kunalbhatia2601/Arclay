            ...
            <section className="relative h-[50vh] lg:h-[55vh] w-full overflow-hidden">
                ...
                <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                        <span className="inline-flex items-center gap-2 bg-[var(--c-accent)] text-white text-xs font-semibold px-5 py-2 rounded-full mb-6">
                ...
                <div className="container mx-auto px-4 xl:px-8 max-w-7xl">
                    {loading ? (
                        ...
                        <div className="text-center py-16 max-w-md mx-auto">
                            <Package className="w-12 h-12 mx-auto mb-4 text-[var(--c-primary)]/40" strokeWidth={1.5} />
                            <h3 className="font-serif text-xl font-bold text-[var(--c-text)] mb-2">No Bundles Yet</h3>
                                ...
                                return (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className="group block bg-white border border-[var(--c-border)] rounded-3xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all"
                                        >
                                            <div className="relative aspect-[4/3] bg-[var(--c-surface-alt)] overflow-hidden">
                                                {coverImage ? (
                                                    <img
                                                        src={coverImage}
                                                        alt={bundle.title}
                                                    ...
                                                    <div className="w-full h-full flex items-center justify-center">
                                                        <Gift className="w-16 h-16 text-[var(--c-primary)]/30" strokeWidth={1.2} />
                                                    </div>
                                                )}
                                                <span className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-full text-[11px] font-bold text-[var(--c-text)] uppercase tracking-wider shadow-sm">
                                                    {productCount} {productCount === 1 ? "item" : "items"}
                                                </span>
                                            </div>
                                            <div className="p-6">
                                                <h3 className="font-serif text-xl font-bold text-[var(--c-text)] mb-3 group-hover:text-[#647345] transition-colors">
                                                    {bundle.title}
                                                </h3>
                                                {products.length > 0 && (
                                                    <p className="text-[var(--c-text-muted)] text-sm leading-relaxed mb-5 line-clamp-2">
