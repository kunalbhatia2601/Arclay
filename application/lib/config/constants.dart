class AppConstants {
  ...
  static const String razorpayCreateEndpoint = '/api/payment/razorpay/create-order';
  static const String razorpayVerifyEndpoint = '/api/payment/razorpay/verify';
  static const String stripeCreateEndpoint = '/api/payment/stripe/create-intent';
  
  // App Info
  static const String appName = 'ESSVORA';
  static const String appDescription = 'Gourmet Indian Food - Premium Pickles & Snacks';
